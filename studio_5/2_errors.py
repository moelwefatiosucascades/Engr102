...
def you_forgot_something():
    ...
    # Your Answer: In Python, a single equal sign = is used for assignment, while two consecutive equal signs == are used for comparison.
...
def it_does_not_compute():
    ...
    # TODO: What is the type of error for this? (What's in the place of xxxxxxx)
    # Your answer: unsupported operand type(s)
...
def giving_functions_the_wrong_stuff():
    ...
    my_int_2 = int("7") # What happens if we try to pass a non-number?
